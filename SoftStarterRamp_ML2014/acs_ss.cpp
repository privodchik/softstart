 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Oct 11 15:36:46 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME acs_ss
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        uABC
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       outMeandr
...
#define SOURCEFILES           "__SFB__TF/integrator.cpp"
#define PANELINDEX            8
...
extern void acs_ss_Start_wrapper(const real_T *Ts_, const int_T p_width0);
extern void acs_ss_Outputs_wrapper(const real_T *uABC,
			real_T *gains,
			real_T *outUy,
			real_T *outMeandr,
...
static void mdlStart(SimStruct *S)
{
    ...
    acs_ss_Start_wrapper(Ts_, p_width0);
}
#endif /*  MDL_START */
...
{
    const real_T *uABC = (real_T *) ssGetInputPortRealSignal(S, 0);
    real_T *gains = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *outUy = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *outMeandr = (real_T *) ssGetOutputPortRealSignal(S, 2);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T *Ts_ = (const real_T *) mxGetData(PARAM_DEF0(S));
    
    acs_ss_Outputs_wrapper(uABC, gains, outUy, outMeandr, Ts_, p_width0);
