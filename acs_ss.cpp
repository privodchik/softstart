 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Oct 13 14:00:23 2021
 */
...
#define SOURCEFILES           "__SFB__INC_PATH TF;__SFB__TF/integrator.cpp__SFB__ss_file.cpp"
#define PANELINDEX            8
...
extern void acs_ss_Outputs_wrapper(const real_T *Vabc,
			real_T *gains,
			real_T *out,
			real_T *out2,
...
{
    const real_T *Vabc = (real_T *) ssGetInputPortRealSignal(S, 0);
    real_T *gains = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *out = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *out2 = (real_T *) ssGetOutputPortRealSignal(S, 2);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T *Ts_ = (const real_T *) mxGetData(PARAM_DEF0(S));
    
    acs_ss_Outputs_wrapper(Vabc, gains, out, out2, Ts_, p_width0);
